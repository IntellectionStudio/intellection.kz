      ...
      <Page {...this.props}>
        <div className={styles.container}>
          <div className={styles.heading}>
            <p className={styles.headingText}>{heading.text}</p>
            <h1 className={styles.headingTitle}>{heading.title}</h1>
          </div>
              ...
              <div className={styles.statsContainer}>
                ...
                <div className={styles.divInfo}>
                  <div className={styles.divSalary}>
                    <h2 className={styles.salaryAmount}>{salary.amount}</h2>
                ...
                <div key={course.title} className={styles.course}>
                  ...
                  <div className={styles.attributes}>
                    {course.attributes.map(attr => (
                      ...
                      >
                        ...
                        <p className={styles.attributeText}>{attr.text}</p>
                      </div>
                    ))}
                  </div>
                  <div className={styles.courseSummary}>
                    <div className={styles.price}>
                      ...
                      <p className={styles.priceText}>{course.price.text}</p>
                    </div>
